...
public class Constants {
    ...
    public static final String DISCONNECT = "DISCONNECT FROM MICRO:BIT(s)";
    ...
    public static final short MICROBIT_EVENT_VALUE_BUTTON_A = 0;
    ...
    public static final String SCAN_FOR_MICROBIT = "SCAN FOR MICRO:BIT(S)";
    public static final String SCAN_FOR_PAIRED_MICROBIT = "SCAN FOR PAIRED MICRO:BIT(S)";
